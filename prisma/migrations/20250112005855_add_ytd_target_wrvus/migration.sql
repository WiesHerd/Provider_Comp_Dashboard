/*
  ...
  - You are about to drop the column `ytdTarget` on the `ProviderMetrics` table. All the data in the column will be lost.
  - Added the required column `ytdTargetWRVUs` to the `ProviderMetrics` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_ProviderMetrics" (
    "id", "providerId", "year", "month", "actualWRVUs", "rawMonthlyWRVUs", 
    "ytdWRVUs", "ytdTargetWRVUs", "targetWRVUs", "baseSalary", "totalCompensation",
    "incentivesEarned", "holdbackAmount", "wrvuPercentile", "compPercentile",
    "planProgress", "monthsCompleted", "createdAt", "updatedAt"
)
SELECT 
    "id", "providerId", "year", "month", "actualWRVUs", "rawMonthlyWRVUs",
    "ytdWRVUs", "ytdTarget", "targetWRVUs", "baseSalary", "totalCompensation",
    "incentivesEarned", "holdbackAmount", "wrvuPercentile", "compPercentile",
    "planProgress", "monthsCompleted", "createdAt", "updatedAt"
