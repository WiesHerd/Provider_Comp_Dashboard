...
CREATE TABLE "providers" (
    ...
    "tieredCFConfigId" TEXT,
    CONSTRAINT "providers_tieredCFConfigId_fkey" FOREIGN KEY ("tieredCFConfigId") REFERENCES "TieredCFConfig" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "CompensationChange" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "CompensationChange_tieredCFConfigId_fkey" FOREIGN KEY ("tieredCFConfigId") REFERENCES "TieredCFConfig" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
...
-- CreateIndex
CREATE INDEX "CompensationChange_tieredCFConfigId_idx" ON "CompensationChange"("tieredCFConfigId");
