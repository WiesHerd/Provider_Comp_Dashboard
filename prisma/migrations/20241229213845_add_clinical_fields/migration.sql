...
INSERT INTO "new_providers" ("baseSalary", "compensationModel", "createdAt", "department", "email", "employeeId", "firstName", "fte", "hireDate", "id", "lastName", "specialty", "status", "terminationDate", "updatedAt") SELECT "baseSalary", "compensationModel", "createdAt", "department", "email", "employeeId", "firstName", "fte", "hireDate", "id", "lastName", "specialty", "status", "terminationDate", "updatedAt" FROM "providers";
