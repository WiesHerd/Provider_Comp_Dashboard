/*
  ...
  - You are about to drop the column `amount` on the `WRVUAdjustment` table. All the data in the column will be lost.
...
INSERT INTO "new_WRVUAdjustment" ("createdAt", "id", "name", "providerId", "updatedAt", "year") SELECT "createdAt", "id", "name", "providerId", "updatedAt", "year" FROM "WRVUAdjustment";
