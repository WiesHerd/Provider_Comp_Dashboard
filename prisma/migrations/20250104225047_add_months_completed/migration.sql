...
INSERT INTO "new_ProviderMetrics" ("actualWRVUs", "baseSalary", "compPercentile", "createdAt", "holdbackAmount", "id", "incentivesEarned", "month", "planProgress", "providerId", "rawMonthlyWRVUs", "targetWRVUs", "totalCompensation", "updatedAt", "wrvuPercentile", "year", "ytdWRVUs") SELECT "actualWRVUs", "baseSalary", "compPercentile", "createdAt", "holdbackAmount", "id", "incentivesEarned", "month", "planProgress", "providerId", "rawMonthlyWRVUs", "targetWRVUs", "totalCompensation", "updatedAt", "wrvuPercentile", "year", "ytdWRVUs" FROM "ProviderMetrics";
